    ...
    >
      <form className="space-y-5" onSubmit={handleSubmit(submit)}>
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label>
            <span className="mb-1 block text-sm font-medium text-slate-700">GST Invoice Type</span>
...
export default function InvoicesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Invoices"
        subtitle="GST sales and purchase invoices with stock and voucher posting."
        actions={
          canModify
            ? [
                <button
      ...
      <div className="space-y-2 text-xs text-slate-500">
        <div>PDF exports are generated by the backend invoice renderer and downloaded locally.</div>
        <div>Invoice creation also posts the matching voucher and stock movements inside a database transaction.</div>
      </div>
    </div>
  );
}
